...
public interface SalidasPresupuestoDao {
    ...
    @Delete
    void delete(SalidasPresupuesto salidasPresupuesto);
    ...
    @Query("SELECT * FROM SalidasPresupuesto WHERE IdSalidaPresupuesto =:Id")
    LiveData<SalidasPresupuesto> getOne(int Id);
}
